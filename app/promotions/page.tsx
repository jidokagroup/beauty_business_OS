...
export const metadata: Metadata = {
  title: "Marketing - Luna & Sage Demo OS",
...
const tools = [
  ...
  },
  {
    ...
    copy: "Track competitor moves, search shifts, content opportunities, and recommendations for what Luna & Sage Studio should post next.",
...
export default async function PromotionsPage() {
  ...
  return (
    <PageShell
      ...
      intro="Create promotions, schedule social content, track what actually booked, and use the brand brain to keep generated content aligned with Luna & Sage Studio."
