...
export const metadata: Metadata = { title: "Social Smart Scheduler - Luna & Sage Demo OS" };
...
const queue = [
  ...
  ["Google Business Profile", "Thursday 12:00 PM", "LUNA SKIN facial opening + review prompt", "Medium confidence"],
