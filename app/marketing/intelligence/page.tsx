...
export const metadata: Metadata = { title: "Marketing Intelligence - Luna & Sage Demo OS" };
...
export default async function IntelligencePage() {
  ...
  return (
    <PageShell eyebrow="Marketing" title="Competitor and content intelligence." intro="Use market signals, competitor movement, and report data to decide what Luna & Sage Studio should post, offer, and test next." wide>
