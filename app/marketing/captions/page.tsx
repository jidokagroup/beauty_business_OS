...
export const metadata: Metadata = { title: "Caption Generator - Luna & Sage Demo OS" };
    ...
    <PageShell eyebrow="Marketing" title="Caption generator." intro="Generate social captions from Brand Brain, reports, client segments, and active promotions." wide>
      <section className="grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <textarea className="mt-2 min-h-28 w-full rounded-md border border-border bg-white px-3 py-2 text-sm" defaultValue="Fill last-minute facial openings and invite clients to book a LUNA SKIN Signature Facial." />
        ...
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <p className="mt-4 text-sm leading-7 text-text-secondary">
            Your skin does not need a reset button. It needs a little time, the right hands, and a treatment that meets it where it is. We have limited facial openings this week for LUNA SKIN Signature Facials. Request your appointment and leave feeling lighter, brighter, and cared for.
          </p>
        </div>
      </section>
    </PageShell>
