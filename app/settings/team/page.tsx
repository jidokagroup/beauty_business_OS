...
export const metadata: Metadata = {
  title: "Team & locations — Luna & Sage Demo OS",
};
...
export default async function TeamSettingsPage({
  ...
  return (
    <PageShell
      ...
      intro="Luna & Sage Demo OS includes 3 teammates per location. Extra teammates are $5/month, and every additional location starts its own monthly subscription."
