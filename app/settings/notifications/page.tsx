...
export const metadata: Metadata = {
  title: "Notification Settings - Luna & Sage Demo OS",
  description: "Customer and team notification routing for Luna & Sage Demo OS.",
};
...
export default async function NotificationSettingsPage() {
  ...
  return (
    <PageShell
      ...
      intro="Control what customers and team members receive, where they receive it, and when Luna & Sage Demo OS should send or surface each automated reminder."
      wide
    >
