...
export const metadata: Metadata = { title: "Concierge Settings — Luna & Sage Demo OS" };
...
export default async function ConciergeSettingsPage() {
  ...
  return (
    <PageShell
      ...
      intro="Use Retell AI, or a similar voice agent, as Luna & Sage Studio' receptionist. Calls and chat summaries can be logged to Google Sheets and displayed in the concierge inbox."
      wide
    >
      <div className="grid gap-5 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <section className="rounded-xl border border-border bg-surface-elevated p-6">
          ...
          <div className="mt-4 grid gap-3 text-sm leading-relaxed text-text-secondary">
            ...
            <p>3. Send barbering requests to Jordan at (555) 018-3102.</p>
            <p>4. Send career, suite, and chair rental requests to Morgan at (555) 018-7780.</p>
      ...
      <section className="mt-6 rounded-xl border border-border bg-surface p-6">
        <p className="font-serif text-2xl font-medium">Google Sheets tabs used for Luna & Sage Studio</p>
