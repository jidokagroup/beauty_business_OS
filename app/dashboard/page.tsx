...
export const metadata: Metadata = {
  title: "Dashboard - Luna & Sage Demo OS",
};

const staff = ["Avery", "Nova", "Jordan", "Riley"];
...
export default async function DashboardPage() {
  ...
  const businessName = profile?.businessName || session.salon || "Luna & Sage Studio";
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <span className="text-sm text-text-secondary">Single-location today. Multi-location selection is ready as Luna & Sage Studio grows.</span>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/wallet?salon=Luna%20%26%20Sage%20Studio" className="rounded-md bg-[#171717] px-4 py-2 text-sm font-medium text-white">Checkout</Link>
            <Link href="/clients" className="rounded-md border border-border bg-white px-4 py-2 text-sm font-medium">Add customer</Link>
            <Link href="/store?salon=Luna%20%26%20Sage%20Studio" className="rounded-md border border-border bg-white px-4 py-2 text-sm font-medium">Retail</Link>
          </div>
        </div>
      </section>
