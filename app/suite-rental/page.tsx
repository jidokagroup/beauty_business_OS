...
export const metadata: Metadata = {
  title: "Rent + Careers — Luna & Sage Studio",
};
...
export default function SuiteRentalPage() {
  ...
  return (
    <PageShell
      ...
      title="Build your beauty career at Luna & Sage Studio."
      intro="For all career, suite, and chair rental opportunities, contact Morgan directly. Luna & Sage Studio welcomes hair dressers, barbers, cosmetologists, estheticians, and beauty professionals looking for a supportive studio home."
    ...
    >
      <div className="grid gap-5 md:grid-cols-[1fr_0.9fr]">
        <section className="rounded-xl border border-border bg-surface p-6">
          <p className="text-[11px] uppercase tracking-[0.2em] text-text-muted">Contact Morgan</p>
          <h2 className="mt-3 font-serif text-3xl font-medium">Career, suite, and chair rental inquiries</h2>
          <p className="mt-4 text-sm leading-relaxed text-text-secondary">
            Text or call Morgan for current availability, chair rental options, suite opportunities, and commission-based
            roles inside Luna & Sage Studio.
          </p>
