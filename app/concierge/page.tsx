...
export const metadata: Metadata = { title: "AI Concierge Inbox — Luna & Sage Demo OS" };
export const revalidate = 30;

const sampleRows = [
  { Created: "Today", Channel: "Phone call", "Client Name": "New client", Contact: "(555) 019-0190", Message: "Asked for lash extension availability this Sunday.", Intent: "Booking", Status: "New", "Assigned To": "AI Concierge" },
  { Created: "Today", Channel: "Website chat", "Client Name": "Jasmine", Contact: "jasmine@example.com", Message: "Asked whether dermaplaning is good before an event.", Intent: "Pricing", Status: "New", "Assigned To": "Avery" },
  { Created: "Yesterday", Channel: "SMS", "Client Name": "Taylor", Contact: "(555) 019-0112", Message: "Wanted to reschedule a facial.", Intent: "Reschedule", Status: "Follow up", "Assigned To": "Front desk" },
];
...
export default async function ConciergePage() {
  ...
  return (
    <PageShell
      ...
      intro="Route Retell phone calls, website chat, SMS, and social messages into the Luna & Sage Studio dashboard. The concierge can answer common questions, capture booking intent, and hand off anything that needs a human."
