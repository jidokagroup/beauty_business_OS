...
export const metadata: Metadata = { title: "Assistants — Luna & Sage Demo OS" };
...
export default async function AssistantsPage() {
  ...
  return (
    <PageShell
      eyebrow="Assistants"
      title="Five assistants, one Luna & Sage Studio command center."
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="rounded-lg border border-border bg-surface-elevated p-6">
          ...
          <h2 className="mt-3 font-serif text-3xl font-medium">This week at Luna & Sage Studio</h2>
