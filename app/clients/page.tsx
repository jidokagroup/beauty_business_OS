...
export const metadata: Metadata = {
  title: "Customers - Luna & Sage Demo OS",
...
const sampleClients: Record<string, string>[] = [
  { Name: "Jasmine Rivera", Email: "jasmine@example.com", Phone: "(555) 019-0142", "Last visit": "2026-07-02", Service: "Classic lash fill", "Interval days": "21", Spent: "$1,240", SMS: "on", EmailOptIn: "on" },
  { Name: "Sandra Miller", Email: "sandra@example.com", Phone: "(555) 019-0188", "Last visit": "2026-04-01", Service: "Custom facial", "Interval days": "90", Spent: "$680", SMS: "on", EmailOptIn: "off" },
  { Name: "John Brooks", Email: "john@example.com", Phone: "(555) 019-0199", "Last visit": "2026-03-10", Service: "Barbering", "Interval days": "30", Spent: "$410", SMS: "off", EmailOptIn: "on" },
];
