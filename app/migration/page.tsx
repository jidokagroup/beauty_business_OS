...
export const metadata: Metadata = {
  title: "Vagaro migration — Luna & Sage Demo OS",
};
...
const MIGRATION_GROUPS = [
  {
    ...
    items: [
      ...
      "Client-facing booking links from luna-sage-demo.example",
    ],
  },
  {
    title: "Client data",
...
const CUTOVER_STEPS = [
  "Run Luna & Sage Demo OS booking in parallel with Vagaro for internal tests.",
  "Import service menu, artists, business hours, and booking rules.",
  "Replace luna-sage-demo.example Vagaro buttons with /book.",
  "Confirm first real appointments inside Luna & Sage Demo OS.",
...
export default function MigrationPage() {
  return (
    <PageShell
      eyebrow="Migration"
      title="Switch Luna & Sage Studio from Vagaro."
      intro="Use this page as the operating checklist for replacing the current external booking handoff with Luna & Sage Demo OS without losing client, team, service, or inventory context."
      wide
    >
