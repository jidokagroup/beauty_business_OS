...
export async function POST(request: NextRequest) {
  ...
  if (saved.ok) {
    ...
    await sendPlainEmail({
      to: email,
      subject: `You're invited to ${session.salon} on Luna & Sage Demo OS`,
      text:
        `${name},\n\n${session.salon} invited you to Luna & Sage Demo OS. Go to ${base}/login, choose Create Account, use this email address, and finish creating your password.\n\nYour starting access level: ${accessLevel}.`,
    });
  }
