...
const nav = [
  ...
  { href: "/wallet?salon=Luna%20%26%20Sage%20Studio", label: "Checkout" },
  { href: "/clients", label: "Customers" },
  { href: "/store?salon=Luna%20%26%20Sage%20Studio", label: "Retail" },
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#2f2f2f] bg-[#30302f] text-white">
      <div className="flex h-14 items-center gap-2 px-3 sm:px-4">
        ...
        <div className="hidden max-w-[180px] truncate text-sm lg:block">{session.salon || "Luna & Sage Studio"}</div>
      </div>
    </header>
  );
}
