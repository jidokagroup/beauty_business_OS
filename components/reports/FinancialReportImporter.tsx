      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-text-secondary">
            Upload Vagaro, Stripe, or spreadsheet exports here. Luna & Sage Demo OS saves the normalized data into the FinancialReports tab so Reports and the Financial Assistant can use it.
          </p>
        </div>
