export const BARE_STUDIOS = {
  name: "Luna & Sage Studio",
  address: "123 Demo Avenue, Suite 200, Atlanta, GA 30303",
  phone: "(555) 018-2044",
  conciergePhone: "(555) 018-2044",
  barberPhone: "(555) 018-3102",
  womensHairPhone: "(555) 018-4418",
  careersPhone: "(555) 018-7780",
  website: "https://example.com/luna-sage-studio",
};
...
export const BARE_SERVICE_CATEGORIES: { name: string; services: BareService[] }[] = [
  {
    ...
    services: [
      {
        name: "Barbering with Jordan",
        duration: "Call or text to book",
        price: "Book directly with Jordan",
        kind: "barber",
      },
    ],
  },
  {
    ...
    services: [
      {
        name: "Womens Hair with Riley",
        duration: "Call or text to book",
        price: "Book directly with Riley",
        kind: "womensHair",
      },
    ],
  },
  {
    ...
    services: [
      {
        name: "LUNA SKIN Signature Facial (Tier 1)",
        duration: "60 min",
        price: "$95",
        kind: "facial",
        description:
      ...
      {
        name: "LUNA SKIN Anti-Aging Facial (Tier 2)",
        duration: "90 min",
        price: "$145",
        kind: "facial",
        description:
      ...
      {
        name: "LUNA SKIN Dermaplaning Facial (Tier 3)",
        duration: "90 min",
        price: "$200",
        kind: "facial",
        description:
      ...
      {
        name: "LUNA SKIN Aveda Plant Peel (Tier 4)",
        duration: "60 min",
        price: "$120",
        kind: "facial",
        description:
      ...
      {
        name: "LUNA SKIN Full Body Treatment",
        duration: "90 min",
        price: "$250",
        kind: "body",
        description:
